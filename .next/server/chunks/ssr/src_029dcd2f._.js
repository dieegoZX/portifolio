...
function ProjetosPage() {
    ...
    const handleDelete = async (id)=>{
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$data$3a$e856e7__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["deleteItem"])('projects', id, '/admin/projetos');
        if (result.success) {
            toast({
                title: 'Sucesso',
...
//# sourceMappingURL=src_029dcd2f._.js.map