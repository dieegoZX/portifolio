...
"[project]/src/app/admin/depoimentos/page.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function DepoimentosPage() {
    ...
    const handleDelete = async (id)=>{
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$data$3a$4de7f1__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["deleteItem"])('testimonials', id, '/admin/depoimentos');
        if (result.success) {
            toast({
                title: 'Sucesso',
...
//# sourceMappingURL=src_f428bbd1._.js.map